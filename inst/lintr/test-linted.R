test_that("testing package is linted correctly", {
  ...
  # (including the NULLS) Using the dev version of lintr is giving a warning but still seems to be running:
  # https://github.com/jimhester/lintr/pull/813 Needs the dev version though otherwise when running check get errors
  # about missing `source_file` argument
